...
//                                String userId = documentSnapshot.getId();
                                ...
                                EditText mobileView = findViewById(R.id.mobileCheckOut);
                                EditText address1View = findViewById(R.id.address1CheckOut);
                                EditText address2View = findViewById(R.id.address2CheckOut);
                                EditText cityView = findViewById(R.id.cityCheckOut);
                                EditText postalcodeView = findViewById(R.id.postalcodeCheckOut);
