...
public class OrdersAdapter extends RecyclerView.Adapter<OrdersAdapter.ViewHolder> {
    ...
    public OrdersAdapter(ArrayList<Order> orders, Context context, OrderSelectListener orderSelectListener) {
        this.orders = orders;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.orderCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                orderSelectListener.selectOrder(orders.get(position));
            }
        });
